  ...
  <div className="container mx-auto px-4">
    ...
    <main className="mt-20 flex-col text-center">
      <section className="flex-1">
        ...
        <button class="bg-transparent hover:bg-white-500 text-white font-semibold hover:text-white py-2 px-4 border border-white rounded cursor-not-allowed">
          Buy Urbit Planet (soon)
        </button>
      </section>
      <section className="flex-1">
